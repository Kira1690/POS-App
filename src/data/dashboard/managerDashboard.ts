...
export const MANAGER_DASHBOARD_DATA: ManagerDashboardData = {
  ...
  quickActions: [
    { label: 'New Order', icon: 'add', color: '#34C759', route: '/orders/new' },
    { label: 'View Tables', icon: 'table-restaurant', color: '#007AFF', route: '/tables' },
    { label: 'Kitchen Display', icon: 'kitchen', color: '#FF9500', route: '/kitchen' },
    { label: 'Daily Report', icon: 'assessment', color: '#AF52DE', route: '/reports/daily' },
    { label: 'Menu Management', icon: 'restaurant-menu', color: '#32D74B', route: '/menu' },
    { label: 'Settings', icon: 'settings', color: '#8E8E93', route: '/settings' },
  ],
  notifications: 5,
  weatherInfo: {
    temperature: '72°F',
