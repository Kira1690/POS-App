 ...
 * Realistic distribution matching restaurant layout
 */
export const MOCK_TABLES: MockTable[] = [
  ...
  { id: 't-002', number: 'T-2', capacity: 2, status: 'occupied', area: 'Main Dining', areaId: 'area-1', positionX: 150, positionY: 50, shape: 'round' },
  ...
  { id: 't-004', number: 'T-4', capacity: 4, status: 'occupied', area: 'Main Dining', areaId: 'area-1', positionX: 50, positionY: 150, shape: 'square' },
  { id: 't-005', number: 'T-5', capacity: 4, status: 'available', area: 'Main Dining', areaId: 'area-1', positionX: 150, positionY: 150, shape: 'square' },
  { id: 't-006', number: 'T-6', capacity: 4, status: 'reserved', area: 'Main Dining', areaId: 'area-1', positionX: 250, positionY: 150, shape: 'square' },
  { id: 't-007', number: 'T-7', capacity: 4, status: 'available', area: 'Main Dining', areaId: 'area-1', positionX: 50, positionY: 250, shape: 'square' },
  { id: 't-008', number: 'T-8', capacity: 6, status: 'occupied', area: 'Main Dining', areaId: 'area-1', positionX: 150, positionY: 250, shape: 'rectangle' },
  { id: 't-009', number: 'T-9', capacity: 4, status: 'available', area: 'Main Dining', areaId: 'area-1', positionX: 250, positionY: 250, shape: 'square' },
  { id: 't-010', number: 'T-10', capacity: 2, status: 'cleaning', area: 'Main Dining', areaId: 'area-1', positionX: 50, positionY: 350, shape: 'round' },
  ...
  { id: 't-013', number: 'VIP-1', capacity: 8, status: 'reserved', area: 'VIP Lounge', areaId: 'area-2', positionX: 400, positionY: 50, shape: 'rectangle' },
  ...
  { id: 't-016', number: 'VIP-4', capacity: 4, status: 'occupied', area: 'VIP Lounge', areaId: 'area-2', positionX: 500, positionY: 50, shape: 'square' },
  ...
  { id: 't-020', number: 'P-2', capacity: 4, status: 'occupied', area: 'Patio', areaId: 'area-3', positionX: 150, positionY: 450, shape: 'square' },
  ...
  { id: 't-024', number: 'P-6', capacity: 4, status: 'reserved', area: 'Patio', areaId: 'area-3', positionX: 250, positionY: 550, shape: 'square' },
  ...
  { id: 't-028', number: 'B-2', capacity: 2, status: 'occupied', area: 'Bar Seating', areaId: 'area-4', positionX: 450, positionY: 450, shape: 'round' },
